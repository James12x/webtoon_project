...
public class PopularActivity extends AppCompatActivity {
    public static PopularActivity instance;
    ...
    public PopularActivity getThis() {
        return this;
    }
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        dl = (DrawerLayout) findViewById(R.id.drawerPop);
        vp = (ViewPager) findViewById(R.id.viewpager);
        //  setupViewPager(vp);

        Toolbar toolbar = (Toolbar) findViewById(R.id.toolbarPopular);
    ...
    public void readDataFinish(String result) {
        try {
            ...
            grid.setAdapter(new GridAdapter(this, coms));
